 ...
 * @author singler
 */
abstract class Application_Model_Object{
    ...
    public static function finder(){
        $className = get_called_class();
        $finder = new Application_Model_Finder(new $className,false);
        return $finder;
    }
    ...
    public function delete(){
        $pk = $this->getPrimaryValue();
        $db = $this->getDBAdapter();
        $db->delete($this->getTableName(), $this->getPrimary()."=".$pk);
    }
